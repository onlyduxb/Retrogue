...
from .item_factory import ItemFactory, WeaponFactory
...
class MenuFactory:
    ...
    ## Methods
    ```
    create_menu(self, options: Dict[Callable[[], str], Callable], name='') -> Menu # Create a menu.
    create_death_menu(self) -> Menu # Create death menu.
    create_give_weapon_menu(self) -> Menu # Create the menu to give player weapons.
    create_give_item_menu(self) -> Menu # Create the menu to give player items.
    create_admin_menu(self) -> Menu # Create admin menu.
    create_settings_menu(self) -> Menu # Create game settings menu.
    create_options_menu(self) -> Menu # Create options menu.
    create_main_menu(self) -> Menu # Create Main menu.
    ```
    """
    ...
    def create_give_weapon_menu(self) -> Menu:
        ...
        for internal_name, params in self.weapon_factory.get_registry().items():
            ...
            def action(w=weapon_obj):
                return {
                    "action": "give_weapon",
                    "weapon": w.name,
                    "rarity": rarities[current_rarity],
                }
    ...
    def create_give_item_menu(self) -> Menu:
    ...
    def create_admin_menu(self) -> Menu:
        """Create admin menu."""
