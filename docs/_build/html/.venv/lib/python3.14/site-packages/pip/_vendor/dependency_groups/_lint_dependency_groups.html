...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../modules.html">src</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../../_sources/.venv/lib/python3.14/site-packages/pip/_vendor/dependency_groups/_lint_dependency_groups.py.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
...
<p>import argparse
import sys</p>
<p>from ._implementation import DependencyGroupResolver
from ._toml_compat import tomllib</p>
<p>def main(*, argv: list[str] | None = None) -&gt; None:
if tomllib is None:
print(
