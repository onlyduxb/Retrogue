...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../modules.html">src</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../../_sources/.venv/lib/python3.14/site-packages/pip/_internal/network/download.py.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
  ...
  <p>“””Download files with progress indicators.”””</p>
...
from typing import BinaryIO</p>
<p>from pip._vendor.requests import PreparedRequest
from pip._vendor.requests.models import Response
from pip._vendor.urllib3 import HTTPResponse as URLlib3Response
from pip._vendor.urllib3._collections import HTTPHeaderDict
from pip._vendor.urllib3.exceptions import ReadTimeoutError</p>
<p>from pip._internal.cli.progress_bars import BarType, get_download_progress_renderer
...
from pip._internal.utils.misc import format_size, redact_auth_from_url, splitext</p>
<p>logger = logging.getLogger(<strong>name</strong>)</p>
<p>def _get_http_response_size(resp: Response) -&gt; int | None:
try:
return int(resp.headers[“content-length”])
except (ValueError, KeyError, TypeError):
return None</p>
<p>def _get_http_response_etag_or_last_modified(resp: Response) -&gt; str | None:
“””
Return either the ETag or Last-Modified header (or None if neither exists).
The return value can be used in an If-Range header.
“””
return resp.headers.get(“etag”, resp.headers.get(“last-modified”))</p>
<p>def _log_download(
resp: Response,
link: Link,
...
url = link.url_without_fragment</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>logged_url = redact_auth_from_url(url)
...
<p>def sanitize_content_filename(filename: str) -&gt; str:
“””
Sanitize the “filename” value from a Content-Disposition header.
“””
return os.path.basename(filename)</p>
<p>def parse_content_disposition(content_disposition: str, default_filename: str) -&gt; str:
“””
...
return filename or default_filename</p>
<p>def _get_http_response_filename(resp: Response, link: Link) -&gt; str:
...
<p>&#64;dataclass
class _FileDownload:
“””Stores the state of a single link download.”””</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>link: Link
...
self._resume_retries = resume_retries</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>def batch(
