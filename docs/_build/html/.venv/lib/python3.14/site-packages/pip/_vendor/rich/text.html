...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../modules.html">src</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../../_sources/.venv/lib/python3.14/site-packages/pip/_vendor/rich/text.py.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
...
<p>if TYPE_CHECKING:  # pragma: no cover
from .console import Console, ConsoleOptions, JustifyMethod, OverflowMethod</p>
<p>DEFAULT_JUSTIFY: “JustifyMethod” = “default”
DEFAULT_OVERFLOW: “OverflowMethod” = “fold”</p>
<p>_re_whitespace = re.compile(r”\s+$”)</p>
<p>TextType = Union[str, “Text”]
“””A plain string or a :class:<code class="docutils literal notranslate"><span class="pre">Text</span></code> instance.”””</p>
<p>GetStyleCallable = Callable[[str], Optional[StyleType]]</p>
<p>class Span(NamedTuple):
“””A marked up region in some text.”””</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>start: int
&quot;&quot;&quot;Span start index.&quot;&quot;&quot;
end: int
&quot;&quot;&quot;Span end index.&quot;&quot;&quot;
...
<p>class Text(JupyterMixin):
“””Text with color / style.</p>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>text = Text(
